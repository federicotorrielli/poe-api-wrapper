...
class PoeApiTest(unittest.TestCase):
    ...
    def test_send_message(self):
        client = PoeApi(tokens=TOKEN)
        for _ in client.send_message(
            bot="a2",
            message="Nice to meet you. Write a 100 word essay about the moon",
    ...
    def test_upload_file(self):
        ...
        for _ in client.send_message(
            bot="a2",
            message="Compare 2 files and describe them in 100 words",
            file_path=file_urls,
        ):
            pass
    ...
    def test_cancel_message(self):
        ...
        for chunk in client.send_message(
            bot="a2", message="What is the meaning of life (100 words)?"
        ):
            i += 1
            if i >= 2:
    ...
    def test_retry_message(self):
        client = PoeApi(tokens=TOKEN)
        for _ in client.send_message(
            bot="capybara", message="Explain Quantaum Mechanics in 50 words"
        ):
            pass
        chatCode = client.get_chat_history("capybara")["data"]["capybara"][0][
            "chatCode"
        ]
    ...
    def test_edit_knowledge(self):
        ...
        client.edit_knowledge(
            knowledgeSourceId=source_ids["What is Quora?"][-1],
            title="What is Quora?",
            content="Quora is a question-and-answer platform where users can ask questions, provide answers, and engage in discussions on various topics.",
        )
    ...
    def test_edit_bot(self):
        ...
        client.edit_bot(
            ...
            knowledgeSourceIdsToRemove=source_ids,
        )
